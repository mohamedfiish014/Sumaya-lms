      ...
      <div className="flex flex-col h-full">
        ...
        <div className="flex flex-col space-y-4 p-4 ">
          ...
          <div className='border-b border-white'>
            ...
            <Link to="/courses/add" className="flex items-center text-lg text-white hover:text-gray-900 hover:bg-gray-200 rounded-lg p-3">
          ...
          <div className='border-b border-white'>
            ...
            <Link to="/students/add" className="flex items-center text-lg text-white hover:text-gray-900 hover:bg-gray-200 rounded-lg p-3">
              <FaUserGraduate className="mr-4 text-xl" />
              Add Student
            </Link>
            <Link to="/students/all" className="flex items-center text-lg text-white hover:text-gray-900 hover:bg-gray-200 rounded-lg p-3">
              <FaUserGraduate className="mr-4 text-xl" />
              All Students
            </Link>
          </div>
